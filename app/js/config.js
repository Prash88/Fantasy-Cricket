...
app.config(['$routeProvider', 
    function($routeProvider) {
      ...
      .when('/iplclubs',{ templateUrl: 'views/ipl/teamlist.html'
              , authRequired: true })
      .when('/iplclubs/:iplteamindex', { templateUrl: 'views/ipl/teamview.html'
              , authRequired: true })
  ...
  .constant('FBURL', 'https://cricfantasyapp.firebaseio.com')
